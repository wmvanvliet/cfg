...
# variable IPYTHONDIR.
# c.IPythonQtConsoleApp.ipython_dir = u'/usr/home/marijn/.config/ipython'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'/usr/home/marijn/.config/ipython'
